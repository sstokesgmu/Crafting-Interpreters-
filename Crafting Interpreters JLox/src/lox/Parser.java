...
class Parser {
    ...
    private Expr primary() {
      ...
      /*Handle Error*/ throw error(peek(), "Except expression.");
    }
    ...
    private Token advance() {
        if (!isAtEnd()) current++; //if not at end keep incrementing through
        return previous();
    }
    ...
    private void synchronize() {
        ...
        while (!isAtEnd()) {
            ...
            switch (peek().type) {
                case CLASS: case FOR: case FUNC: case IF: case PRINT:
